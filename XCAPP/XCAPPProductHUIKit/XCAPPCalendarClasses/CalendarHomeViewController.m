...
- (void)viewDidLoad
{
    ...
    [self setLeftNavButtonTitleStr:@"取消" withFrame:kNavBarButtonRect actionTarget:self action:@selector(leftBarButtonEventClicked)];
...
- (void)setCalendartitle:(NSString *)calendartitle
{
    ...
    [self settingNavTitle:calendartitle];
