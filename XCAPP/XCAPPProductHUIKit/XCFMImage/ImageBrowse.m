...
///水印图片默认大小
#define KMaskImageWidth         KXCUIControlSizeWidth(297.0/2)
#define KMaskImageHeight        KXCUIControlSizeWidth(35.0/2)
...
#define waterMarkImage  @"LvYeAPPDownLoadIcon.png"
- (void)clickImageSave
{
    ...
    im.bSaved = YES;
    WaittingMBProgressHUD(HUIKeyWindow,@"保存图片...");
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithImage:saveImage];
