...
- (void)insertForDataWithObject:(id)obj atIndex:(NSInteger)index{
    if (!obj)return;
    
    [self.dataContainer insertObject:obj atIndex:index];
}

- (void)replaceForDataWithObjectAtIndex:(NSInteger)index withObject:(id)obj{
